...
Pod::Spec.new do |s|
  s.name             = 'LottieExtra'
  s.version          = '0.1.0'
  s.summary          = 'A short description of LottieExtra.'
...
TODO: Add long description of the pod here.
  ...
  s.homepage         = 'https://github.com/oxape/LottieExtra'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'oxape' => '1054572107@qq.com' }
  s.source           = { :git => 'https://github.com/oxape/LottieExtra.git', :tag => s.version.to_s }
